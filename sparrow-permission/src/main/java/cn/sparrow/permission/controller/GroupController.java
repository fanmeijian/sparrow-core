...
import cn.sparrow.permission.service.organization.GroupService;
...
public class GroupController {
	...
	@GetMapping("/groups/getModelName")
	public String getModelName() {
		return "{\"modelName\":\"" + Group.class.getName() + "\"}";
	}
	...
	public SparrowTree<Group, String> tree(@Nullable @RequestParam("parentId") String parentId) {
