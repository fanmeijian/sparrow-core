...
//					"本条数据拒绝更新权限" + target.getClass().getName() + ((AbstractSparrowUuidEntity) target).getId() + username);
//		}
//
//		// 2.本条数据的的编辑权限
//		if (!dataPermissionService.hasPermission(new AbstractDataPermissionPK(target.getClass().getName(),
...
//					"无本条数据更新权限" + target.getClass().getName() + ((AbstractSparrowUuidEntity) target).getId() + username);
//		}
