...
//		logger.info("finish sysrole init.");
	...
	public void initMenu() {
		...
		jdbcTemplate.execute("insert into spr_menu(id, name, parent_id, url, created_date, modified_by, modified_date,created_by,is_system) values('"+ menuList.get(1) + "','机构管理','"+ menuList.get(0) + "','/organization',now(),'SparrowSystem',now(),'SparrowSystem',true);");
		...
		jdbcTemplate.execute("insert into spr_menu(id, name, parent_id, url, created_date, modified_by, modified_date,created_by,is_system) values('"+ menuList.get(7) + "','接口管理','"+ menuList.get(6) + "','/url',now(),'SparrowSystem',now(),'SparrowSystem',true);");
